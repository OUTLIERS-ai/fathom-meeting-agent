...
```
git clone https://github.com/OUTLIERS-ai/fathom-meeting-agent.git
```
...
because Fathom has no free way in.
...
About 200MB, about 5 minutes. Playwright is free and made by Microsoft.
